...
pub(super) const INCREASE_DERIVATIVE_EXCHANGE_ALLOCATION_CODE: &str =
    "INCREASE_DERIVATIVE_EXCHANGE_ALLOCATION";
pub(super) const INCREASE_DERIVATIVE_EXCHANGE_ALLOCATION_ID: Uuid =
    uuid!("00000000-0000-0000-0000-000000000003");
pub(super) const DECREASE_DERIVATIVE_EXCHANGE_ALLOCATION_CODE: &str =
    "DECREASE_DERIVATIVE_EXCHANGE_ALLOCATION";
pub(super) const DECREASE_DERIVATIVE_EXCHANGE_ALLOCATION_ID: Uuid =
