...
pub(super) const QUOTES_OMNIBUS_ID: Uuid = uuid!("20000000-3000-0000-0000-000000000000");

pub(super) const QUOTES_LIABILITY: &str = "QUOTES_LIABILITY";
pub(super) const QUOTES_LIABILITY_ID: Uuid = uuid!("20000000-3100-0000-0000-000000000000");
