...
pub(super) const DERIVATIVE_ALLOCATIONS_OMNIBUS: &str = "DERIVATIVE_ALLOCATIONS_OMNIBUS";
pub(super) const DERIVATIVE_ALLOCATIONS_OMNIBUS_ID: Uuid = uuid!("20000000-2000-0100-0100-000000000000");

pub(super) const DERIVATIVE_ALLOCATIONS_OKEX: &str = "DERIVATIVE_ALLOCATIONS_OKEX";
pub(super) const DERIVATIVE_ALLOCATIONS_OKEX_ID: Uuid = uuid!("20000000-2000-0100-0010-000000000000");
