...
pub(super) const INCREASE_EXCHANGE_POSITION_ID: Uuid = uuid!("00000000-0000-0000-0000-000000000003");
pub(super) const DECREASE_EXCHANGE_POSITION_CODE: &str = "DECREASE_EXCHANGE_POSITION";
pub(super) const DECREASE_EXCHANGE_POSITION_ID: Uuid = uuid!("00000000-0000-0000-0000-000000000004");
...
pub(super) const HEDGING_JOURNAL_NAME: &str = "Hedging";
pub(super) const HEDGING_JOURNAL_ID: Uuid = uuid!("00000000-0000-0000-0000-000000000002");
...
pub const OKEX_POSITION_CODE: &str = "OKEX_POSITION";
pub const OKEX_POSITION_ID: Uuid = uuid!("10000000-1000-0000-0000-000000000002");
