...
INSERT INTO
    user_trade_units (name)
VALUES ('satoshi'), ('synthetic_cent');
...
CREATE FUNCTION NOTIFY_USER_TRADES() RETURNS TRIGGER 
AS $$ 
	BEGIN NOTIFY user_trades;
	RETURN NULL;
	END;
	$$ LANGUAGE 
PLPGSQL; 

CREATE TRIGGER USER_TRADES 
	AFTER
	INSERT
	    ON user_trades FOR EACH STATEMENT
	EXECUTE
	    FUNCTION notify_user_trades();
; 
